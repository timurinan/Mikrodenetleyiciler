...
;Uygulama14.c,20 :: 		ADCON1=0X4E;// ADFM=0(LEFT JUSTIFIED),ADCS2=1,
	MOVLW      78
	MOVWF      ADCON1+0
;Uygulama14.c,22 :: 		ADCON0=0X45;//ADCS1=0,ADCS1=1,16 tOSC SEÇÝLDÝ.,CHS2:CHS0=0 KANAL aN0 SEÇÝLDÝ
	MOVLW      69
	MOVWF      ADCON0+0
...
;Uygulama14.c,37 :: 		adc_val= ADC_Read(0);
	...
	MOVF       R0+1, 0
	MOVWF      33
;Uygulama14.c,38 :: 		portd=adc_val;// test amaçlý D portuna gönderilmiþtir
	MOVF       R0+0, 0
	MOVWF      PORTD+0
;Uygulama14.c,39 :: 		carpan=5000.0/1023.0;// bir bite karþýlýk gelen gerilim deðeri
	MOVLW      26
	MOVWF      _carpan+0
	MOVLW      103
	MOVWF      _carpan+1
...
;Uygulama14.c,41 :: 		adc_degeri=adc_val*carpan;
	...
	MOVF       R0+3, 0
	MOVWF      37
;Uygulama14.c,43 :: 		FloatToStr(adc_degeri, dc_val);// //float deðiþkenin stringe çevrilmesi
	MOVF       R0+0, 0
	...
	CALL       _FloatToStr+0
;Uygulama14.c,44 :: 		strcat(dc_val," mV"); // strcat komutu ile iki string birleþtiriliyor.
	MOVLW      _dc_val+0
	MOVWF      FARG_strcat_to+0
	MOVLW      ?lstr1_Uygulama14+0
	MOVWF      FARG_strcat_from+0
	CALL       _strcat+0
;Uygulama14.c,45 :: 		Lcd_Out(1,1,dc_val);// LCD nin 1 satýr 1. sütunundan itibaren yazdýr.
	MOVLW      1
